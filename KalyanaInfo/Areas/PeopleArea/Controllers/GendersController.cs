...
namespace KalyanaInfo.Areas.PeopleArea.Controllers
{
    ...
    public class GendersController : Controller
    {
        ...
        public GendersController(kalyanadiaryContext context)
        {
            _context = context;
        }

        // GET: PeopleArea/Genders
        public async Task<IActionResult> Index()
        {
            return View(await _context.Gender.ToListAsync());
        }

        // GET: PeopleArea/Genders/Details/5
        ...
        // GET: PeopleArea/Genders/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PeopleArea/Genders/Create
        ...
        // POST: PeopleArea/Genders/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PeopleArea/Genders/Delete/5
        ...
        // POST: PeopleArea/Genders/Delete/5
